...
GO
/*
The column [dbo].[DentalMenu].[UserTypeId] is being dropped, data loss could occur.
*/
...
GO
PRINT N'Altering [dbo].[DentalMenu]...';


GO
ALTER TABLE [dbo].[DentalMenu] DROP COLUMN [UserTypeId];
