...
GO
PRINT N'Dropping FK_PatientDiagnosisHistoryDetail_TreatmentTypeId...';


GO
ALTER TABLE [dbo].[PatientDiagnosisHistoryDetail] DROP CONSTRAINT [FK_PatientDiagnosisHistoryDetail_TreatmentTypeId];


GO
PRINT N'Altering [dbo].[PatientDiagnosisHistoryDetail]...';


GO
ALTER TABLE [dbo].[PatientDiagnosisHistoryDetail] ALTER COLUMN [DiagnosisTypeId] INT NULL;

ALTER TABLE [dbo].[PatientDiagnosisHistoryDetail] ALTER COLUMN [TreatmentTypeId] INT NULL;
...
GO
ALTER TABLE [dbo].[PatientDiagnosisHistoryMaster] ALTER COLUMN [AppointmentId] INT NULL;
