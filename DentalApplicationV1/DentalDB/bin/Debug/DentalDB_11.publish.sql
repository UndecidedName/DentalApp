...
GO
ALTER TABLE [dbo].[Appointment] ALTER COLUMN [Status] INT NOT NULL;
...
ALTER TABLE [dbo].[Appointment] WITH NOCHECK
    ADD CONSTRAINT [FK_Appointment_DentistId] FOREIGN KEY ([DentistId]) REFERENCES [dbo].[DentistInformation] ([Id]) ON DELETE CASCADE;
