...
GO
PRINT N'Rename refactoring operation with key 85457814-78f6-41f2-811f-5a930fea9e95 is skipped, element [dbo].[PatientInformation].[UserId] (SqlSimpleColumn) will not be renamed to PatientId';
...
GO
ALTER TABLE [dbo].[Appointment] WITH NOCHECK
    ADD CONSTRAINT [FK_Appointment_DentistId] FOREIGN KEY ([DentistId]) REFERENCES [dbo].[DentistInformation] ([Id]) ON DELETE SET NULL;
...
GO
ALTER TABLE [dbo].[DentistInformation] WITH NOCHECK
...
GO
ALTER TABLE [dbo].[PatientDiagnosisHistoryDetail] WITH NOCHECK
    ADD CONSTRAINT [FK_PatientDiagnosisHistoryDetail_DiagnosisTypeId] FOREIGN KEY ([DiagnosisTypeId]) REFERENCES [dbo].[DiagnosisType] ([Id]) ON DELETE CASCADE;
...
GO
ALTER TABLE [dbo].[PatientDiagnosisHistoryDetail] WITH NOCHECK
    ADD CONSTRAINT [FK_PatientDiagnosisHistoryDetail_TreatmentTypeId] FOREIGN KEY ([TreatmentTypeId]) REFERENCES [dbo].[TreatmentType] ([Id]) ON DELETE CASCADE;
...
GO
ALTER TABLE [dbo].[PatientInformation] WITH NOCHECK
...
ALTER TABLE [dbo].[DentistInformation] WITH CHECK CHECK CONSTRAINT [FK_DentistInformation_CivilStatus];
...
ALTER TABLE [dbo].[PatientInformation] WITH CHECK CHECK CONSTRAINT [FK_PatientInformation_PatientId];

ALTER TABLE [dbo].[PatientInformation] WITH CHECK CHECK CONSTRAINT [FK_PatientInformation_CivilStatusId];
