...
GO
ALTER TABLE [dbo].[Appointment] WITH NOCHECK
    ADD CONSTRAINT [FK_Appointment_DentistId] FOREIGN KEY ([DentistId]) REFERENCES [dbo].[UserInformation] ([Id]);
...
ALTER TABLE [dbo].[UserInformation] WITH CHECK CHECK CONSTRAINT [FK_PatientInformation_PatientId];

ALTER TABLE [dbo].[UserInformation] WITH CHECK CHECK CONSTRAINT [FK_PatientInformation_CivilStatusId];
