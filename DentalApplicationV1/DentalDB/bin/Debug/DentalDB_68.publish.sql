...
IF EXISTS (select top 1 1 from [dbo].[CivilStatus])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Altering [dbo].[CivilStatus]...';


GO
ALTER TABLE [dbo].[CivilStatus] ALTER COLUMN [Description] VARCHAR (200) NULL;

ALTER TABLE [dbo].[CivilStatus] ALTER COLUMN [Name] VARCHAR (50) NOT NULL;
