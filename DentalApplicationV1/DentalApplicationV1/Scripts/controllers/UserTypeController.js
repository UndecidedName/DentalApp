dentalApp.controller("UserTypeController", UserTypeController);
function UserTypeController($scope, LxNotificationService, LxDialogService, LxProgressService, $interval, $filter, $http, $rootScope, $compile) {
    $scope.modelName = "User Type";
    ...
    $scope.initMasterDataGridParameters = function () {
        ...
        $scope.dataDefinitionMaster = {
            ...
            "DataList": $scope.userType,
            "CurrentLength": $scope.userType.length,
