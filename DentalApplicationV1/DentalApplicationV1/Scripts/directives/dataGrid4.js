dentalApp.directive('dirDataGrid4', function () {
    /*---------------------------------------------------------------------------------//
     Directive Name: dirDataGrid2
     Description: used only if dataGrid functionality will only delete/edit record
    ...
    return {
        ...
        templateUrl: '/Directive/DataGrid4',
        controller: function ($scope, $http, $interval, $filter, $parse, $compile, LxProgressService) {
            ...
            $scope.contextMenuLabelDefault = ['Edit', 'Delete'];
            $scope.contextMenuLabelImage = ['mdi mdi-table-edit','mdi mdi-delete'];
            ...
            $scope.action = function (action) {
                switch (action) {
                    case 'Delete':
                        ...
                        $scope.datadefinition.DataItem.Id = $scope.datadefinition.DataList[$scope.selectedIndex].Id
                        $scope.submit(action);
                        break;
                    case 'Edit':
                        $scope.datadefinition.DataItem = {};
